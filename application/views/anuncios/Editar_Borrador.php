                                        ...
                                        <!-- Bread crumb -->
                                                    <form class="form-valide" method="POST" action="" enctype="multipart/form-data" form="formAnuncio" id="formAnuncio">                                    
                                                        <div class="row ">
                                                         ...
                                                         <div class="col-md-12">
                                                                <label style="color: #000000">Titulo de Publicación</label>
                                                            ...
                                                            <div class="col-md-12">
                                                                <label style="color: #000000">Descripción de Publicación</label>
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                            ...
                                                            <div class="col-md-12">
                                                             ...
                                                             <div class="col-md-12">
                                                                <label style="color: #000000">Contenido de Publicación</label>
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                            ...
                                                            <div class="col-md-12">
                                                            <div>
                                                            <label style="color: #000000">Imagen de Publicación</label>
                                                        ...
                                                        <button type="submit" onclick="AccionBoton('<?= base_url() ?>Anuncios/EditarB')" class="btn btn-primary"><i class="fa fa-share-square-o f-s-20" style="margin:10px;"></i>Publicar Noticia</button>    
                                                        </div>
                                                        </div>
