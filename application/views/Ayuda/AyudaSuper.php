...
<div class="container-fluid contenido">
    <div class="row">
        ...
        <div class="card TituloUser" style="height: 60px">
                                    <h3 class="responsive" style="color:white; font-weight:bold; font-size: xx-large;">Preguntas Frecuentes</h3>  
                                </div>
                        <div class="card">
                            <div class="card-body">
                ...
                <div align="center">
                    ...
                    <a href="<?= base_url()?>plantilla/Documentos/MANUAL_INVITADO.pdf" class ="btn btn-info btn-md" style="color:white; padding:20px; margin-left: 20px" target="_blank"><i class="fa fa-download fa-2x" ></i> Descargar Manual Visitante</a><br><br><br></div>
